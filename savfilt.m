% This function was written by Vassili Pastushenko and was downloaded from
% the Mathworks File Exchange:
% http://www.mathworks.com/matlabcentral/fileexchange/5536-savfilt/content/savfilt.m
...
DatF(HW+2:R-HW-1, :) = (DatF(W+1:R-1, :) - DatF(1:R-W-1, :)) .* (1 / W); 
